...
const projects = [
  {
    ...
    capacity: "3.2 kW",
   /* year: "2023",
    saving: "Bhopal, Madhya Pradesh",
    //desc: "Residential Rooftop solution done for Aditi Kaushik",*/
  },
  {
    id: 2,
    title: "Sati Devi Gyanchand",
    location: "Bhopal, Madhya Pradesh",
    category: "Residential",
    capacity: "3.3 kW",
    /*year: "2023",
    ...
    <>
      ...
      <section className="bg-navy py-20 px-6 lg:px-16 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <span className="text-yellow text-xs font-extrabold tracking-widest uppercase block mb-3">Our Projects</span>
