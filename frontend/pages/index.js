          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-navy rounded-2xl p-8 flex flex-col gap-6">
              ...
              {[
                ...
                { icon: "M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2zM22 6l-10 7L2 6", label: t("contact_email_label"), value: "info@narharesolar.com" },
                { icon: "M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0zM12 10a3 3 0 1 1-6 0 3 3 0 0 1 6 0", label: t("contact_office_label"), value: "123, Green Energy Street, Pune, Maharashtra - 411045" },
