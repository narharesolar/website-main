  ...
  return (
    <footer className="bg-[#0d1228] pt-12 pb-6 px-6">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
        ...
        <div>
          <div className="flex items-center gap-2 mb-4">
            ...
            <div>
              ...
              <div className="text-gray-500 text-[8px] tracking-widest uppercase">Solar Solutions</div>
            </div>
          </div>
        ...
        <div>
          ...
          <div className="flex flex-col gap-3">
            {[
              { icon: "M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.62 1h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.6a16 16 0 0 0 6 6l.96-.96a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z", text: "+91 96765 43210" },
              { icon: "M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2zM22 6l-10 7L2 6", text: "info@narharesolar.com" },
              { icon: "M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0zM12 10m-3 0a3 3 0 1 0 6 0 3 3 0 1 0-6 0", text: "123, Green Energy Street, Pune, Maharashtra - 411045" },
            ].map(({ icon, text }, i) => (
      ...
      <div className="max-w-7xl mx-auto border-t border-white/10 pt-5 flex flex-col sm:flex-row justify-between items-center gap-2">
        <p className="text-gray-600 text-xs">© 2024 Narhare Solar Solutions. All Rights Reserved.</p>
